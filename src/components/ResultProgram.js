    ...
    return(
        <View>
            <View style={styles.resultPG}>
                ...
                <Text numberOfLines={2} style={{margin:5, textAlign:'center', fontFamily:'Roboto-Bold',fontSize:13, lineHeight:18, fontWeight:'100'}}>{program.programName}</Text>
