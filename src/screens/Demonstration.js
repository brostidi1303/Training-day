    ...
    <View style={styles.BK}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={{ width: '100%', backgroundColor: '#faf9fe', padding: 15, marginTop: 80 }}>
          ...
          >
            Mọi thông tin minh chứng cần phải đầy đủ vui lòng nhập vào các thông tin bên dưới *
          </Text>
        </View>
        <View style={{ width: '100%', padding: 15, flexDirection: 'column' }}>
          <View style={styles.view_demon}>
            <Text style={styles.nametag}>Họ và tên*</Text>
            <TextInput
          ...
          <View style={styles.view_demon}>
            <Text style={styles.nametag}>MSSV*</Text>
            <TextInput
              style={styles.input_demon}
              value={MSSV}
          ...
          <View style={styles.view_demon}>
            <Text style={styles.nametag}>Mã chương trình*</Text>
            <TextInput
              style={styles.input_demon}
              value={programId}
          ...
          <View style={styles.view_demon}>
            <Text style={styles.nametag}>Loại*</Text>
            <TextInput
              style={styles.input_demon}
              value={type}
          ...
          <View style={styles.view_demon}>
            <Text style={styles.nametag}>Nội dung*</Text>
            <TextInput
              style={styles.input_demon}
              value={content}
